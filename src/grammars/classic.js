...
var grammar = {
    ...
    {"name": "expression$string$1", "symbols": [{"literal":"d"}, {"literal":"o"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "expression$string$2", "symbols": [{"literal":"e"}, {"literal":"n"}, {"literal":"d"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "expression", "symbols": ["expression$string$1", "block", "expression$string$2"], "postprocess": (d,i,r) => d[1][1].length>0?d[1]:r},
